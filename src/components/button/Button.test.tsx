...
describe('Button', () => {
  it('should render Button component with props', () => {
    ...
    render(<Button onClick={onClick} title={title} disabled={true} typeParams={{type: 'select', isSelected: true}}>Click me</Button>);
  ...
  it('should render Button component without type', () => {
    const onClick = jest.fn();
    const title = 'Test button';
